...
class pocsag_rx(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "pocsag_rx", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("pocsag_rx")
        ...
        self.settings = Qt.QSettings("GNU Radio", "pocsag_rx")
        ...
        # Variables
        ##################################################
        self.transition = transition = 18000
        self.samp_rate = samp_rate = 1800000
        self.frequency = frequency = 169400000
        self.cutoff = cutoff = 38000
        ...
        self.low_pass_filter_0 = filter.fir_filter_ccf(
            ...
            firdes.low_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.digital_clock_recovery_mm_xx_0 = digital.clock_recovery_mm_ff(1500, 10000000, 0, 100000000, 10000000)
        self.digital_binary_slicer_fb_0 = digital.binary_slicer_fb()
        self.blocks_stream_to_vector_0 = blocks.stream_to_vector(gr.sizeof_char*1, 64)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*64, '/home/iomonad/iomonad/out.bin', False)
        self.blocks_file_sink_0.set_unbuffered(False)
        self.analog_quadrature_demod_cf_0 = analog.quadrature_demod_cf(916.732)
...
def main(top_block_cls=pocsag_rx, options=None):
